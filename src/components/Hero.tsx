    ...
    <section className="relative bg-white dark:bg-gray-900 overflow-hidden pt-10 pb-24 md:pb-32">
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* Hero Content */}
          <div className={`transition-opacity duration-700 ease-in-out ${isVisible ? 'opacity-100' : 'opacity-0'} order-first lg:order-last`}>
        ...
        {/* Twitter Bookmarks Digest Card (Below on Mobile, Right Side on Desktop) */}
        <div className={`mt-10 lg:mt-0 lg:absolute lg:right-24 lg:top-[21rem] max-w-md transition-all duration-700 ease-in-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
