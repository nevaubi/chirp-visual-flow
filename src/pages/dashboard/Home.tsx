    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Your creator platform dashboard is being updated</p>
        </div>
      </div>
      ...
      <Card className="border-none shadow-sm hover:shadow transition-shadow">
        <CardHeader>
          ...
          <CardDescription>
            We're currently updating the creator platform dashboard with exciting new features.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center justify-center p-10">
          <div className="text-center mb-6">
            <p className="text-gray-600">
              In the meantime, you can check out our new tweet generation feature.
            </p>
          </div>
          <Button 
            asChild
