...
<html>
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      /* Mobile styles - MORE SPECIFIC SELECTORS */
      @media screen and (max-width: 600px) {
        ...
        /* Remove all padding from outer containers */
        body { 
          padding: 0 !important; 
          margin: 0 !important;
        }
        ...
        /* Make wrapper full width with white background */
        .wrapper { 
          width: 100% !important; 
        ...
        /* Footer specific white background */
        .footer-container,
        .footer-cell {
          background: ${COLORS.white} !important;
          background-color: ${COLORS.white} !important;
        ...
        h1 { 
          ...
          color: ${COLORS.primaryNavy} !important; 
        }
        h2 { 
        ...
        blockquote { 
          background: ${COLORS.lightBg} !important; 
          border-left: 5px solid ${COLORS.accentBlue} !important; 
          color: ${COLORS.darkText} !important; 
        }
  ...
  <body bgcolor="${COLORS.lightBg}" style="background-color: ${COLORS.lightBg}; margin: 0; padding: 0; font-family: 'Lato', sans-serif; -webkit-text-size-adjust: 100%; text-size-adjust: 100%;">
    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" bgcolor="${COLORS.lightBg}" style="background-color: ${COLORS.lightBg}; margin: 0; padding: 0;">
      <tr>
      ...
      <!-- Footer moved to separate row for better mobile control -->
      <tr>
        <td align="center" class="footer-cell" style="background-color: ${COLORS.lightBg};">
          <div class="footer-container" style="text-align: center; padding: 30px 0 40px 0; font-size: 14px; color: ${COLORS.darkText}; font-family: 'Lato', sans-serif;">
